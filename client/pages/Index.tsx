        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <Alert className="max-w-md mx-auto mb-8 border-coral bg-coral/10">
              ...
              <AlertDescription>
                Coastal communities face increasing threats from climate change
              </AlertDescription>
            </Alert>
            ...
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
              Advanced early warning system using artificial intelligence to
              detect and predict coastal threats including storm surges,
              erosion, pollution, and illegal activities.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="bg-white text-ocean-medium hover:bg-white/90"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Rising sea levels, extreme weather, and human activities pose
              unprecedented risks to coastal ecosystems and communities
              worldwide.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="border-coral/20 hover:border-coral/40 transition-colors">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Devastating coastal flooding from extreme weather events
            ...
            <Card className="border-orange-500/20 hover:border-orange-500/40 transition-colors">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Progressive land loss endangering coastal properties and
                  critical habitats.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-purple-500/20 hover:border-purple-500/40 transition-colors">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Industrial discharge and oil spills contaminating marine
            ...
            <Card className="border-red-500/20 hover:border-red-500/40 transition-colors">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Unauthorized fishing, dumping, and development threatening
                  protected areas.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge
                variant="outline"
                className="border-ocean-medium text-ocean-medium mb-4"
              >
                AI-Powered Solution
              </Badge>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Our advanced AI system continuously monitors coastal conditions
                using satellite imagery, IoT sensors, and machine learning
                algorithms to detect threats before they become disasters.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      AI models predict threats up to 72 hours in advance
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      24/7 surveillance of coastal conditions and activities
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Instant alerts to relevant authorities and communities
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section id="features" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive coastal protection through cutting-edge technology
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Continuous monitoring from satellites, IoT sensors, and
                  weather stations
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Machine learning algorithms identify patterns and predict
                  threats
                </CardDescription>
              </CardHeader>
              <CardContent>
      ...
      <section id="users" className="py-20 bg-muted/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our platform serves diverse stakeholders working to protect
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  Emergency management, environmental protection, and coastal
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  Environmental organizations and research institutions studying
                  coastal ecosystems.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  Fishing communities and maritime workers who depend on coastal
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              ...
              <CardContent>
                <p className="text-muted-foreground text-sm">
                  First responders and emergency services coordinating disaster
      ...
      <section id="impact" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Our AI-powered early warning system delivers measurable results in
              coastal protection and community safety.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <Card className="border-green-500/20 hover:border-green-500/40 transition-colors">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Reduction in casualties from coastal flooding through early
                    warnings
                  </p>
                  ...
                  <p className="text-muted-foreground">
                    Average advance warning time for storm surge events
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-blue-500/20 hover:border-blue-500/40 transition-colors">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Faster detection of illegal activities in protected marine
                    areas
                  </p>
                  <div className="text-2xl font-bold text-foreground">
                    1,200km²
                  ...
                  <p className="text-muted-foreground">
                    Coastal habitat area under continuous monitoring
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-ocean-medium/20 hover:border-ocean-medium/40 transition-colors">
              <CardHeader>
                ...
                <CardTitle className="text-ocean-medium">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground">
                    Improvement in coastal resource management efficiency
                  </p>
      ...
      <section className="py-20 bg-ocean-light/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Real-time visualization of coastal conditions and threat
              assessments.
            </p>
          </div>
                ...
                <div className="w-full h-64 bg-gradient-to-br from-ocean-light to-ocean-medium rounded-lg flex items-center justify-center">
                  <div className="text-white text-center">
                    ...
                    <p className="text-sm opacity-90">
                      Real-time sensor data and threat visualization
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Contact our team to learn how CoastalAlert can enhance your
                coastal monitoring and emergency preparedness capabilities.
              </p>
      ...
      <section className="py-20 bg-gradient-to-r from-ocean-medium to-ocean-deep text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Be among the first to access our AI-powered coastal threat alert
            system. Early adopters get exclusive features and priority support.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-white/70">
                Protecting coastal communities through AI-powered early warning
                systems.
              </p>
            </div>
