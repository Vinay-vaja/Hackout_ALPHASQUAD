            ...
            <CardContent className="space-y-6">
              <div className="text-left space-y-4">
                <p className="text-muted-foreground">
                  CoastalAlert is a revolutionary AI-powered early warning system designed to protect coastal communities 
                  from the increasing threats posed by climate change and human activities.
                </p>
                <p className="text-muted-foreground">
                  Our team of marine scientists, AI researchers, and disaster management experts work together to create 
                  innovative solutions for coastal protection and community safety.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="text-center p-4 bg-ocean-light/10 rounded-lg">
                  ...
                  <p className="text-sm text-muted-foreground">Expert marine scientists & engineers</p>
                </div>
                <div className="text-center p-4 bg-ocean-light/10 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Want to help build this page? Continue prompting to add more company information!
              </p>
            </CardContent>
          </Card>
        </div>
